...
#         self.label = Label(master, text="So you want to recycle filament...", font = self.header, background = '#d8feff') #sweet, this prints text above the buttons
...
#         self.log_button.place(relx=0.97, rely=0.95, anchor=SE) #log button in bottom right corner (taken from http://stackoverflow.com/questions/25396197/tkinter-put-a-widget-in-the-lower-right-corner-using-place)
